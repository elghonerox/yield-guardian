...
// Mock dependencies
vi.mock('../../agent/autonomous/DecisionEngine');
vi.mock('../../agent/blockchain/BlockchainIntegration');
vi.mock('../../agent/monitoring/YieldMonitor');
vi.mock('../../agent/risk/RiskManager');
vi.mock('../../agent/execution/ExecutionLayer');
